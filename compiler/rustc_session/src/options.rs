...
written to standard error output)"),
    ...
    typeck_docs: bool = (false, parse_bool, [TRACKED],
        "type check function bodies in rustdoc when generating documentation"),
    disable_cfg_doc: bool = (false, parse_bool, [TRACKED],
        "[rustdoc only] do not enable cfg(doc)"),
